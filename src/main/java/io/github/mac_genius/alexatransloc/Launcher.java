package io.github.mac_genius.alexatransloc;
/**
...
import io.github.mac_genius.alexatransloc.translocspeechlet.TranslocSpeechlet;
...
public final class Launcher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new TranslocSpeechlet())), "/transloc");
        server.start();
        server.join();
    }
